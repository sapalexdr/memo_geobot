...
async def send_welcome_message(message: types.Message):
    ...
    await message.answer(
        'Привет! _________________ Два варианта: отправьте боту трансляцию геопизиции или геопозицию или нажмите на кнопку, чтобы искать через название улицы',
...
async def handle_street_search_button(message: Message, state: FSMContext):
    ...
    places = ["Дом на набережной", "Улица Солянка", "Андрониковский монастырь", "Бутырская тюрьма",
              ...
              "Волхонкf", "Коммунистическая улица в Москве", "Большой Спасоглинищевский переулок", "Улица Шаболовка"]
